...
class RolloutComputer:
    ...
    #     # Initialize GAE list
    #     gaes = []
    #     # Initialize the "next non-terminal value"
    #     next_non_terminal = 1.0
    #     # Initialize the "next value" to the value of the last state
    #     next_value = last_state_val
    ...
    #         # Update next value
    #         next_value = values[t]
    #         # Calculate GAE and prepend it to the list
    #         gae = delta + gamma * gae_lambda * next_non_terminal * (gaes[0] if gaes else 0)
    #         gaes.insert(0, gae)
    #
